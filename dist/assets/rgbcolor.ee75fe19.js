  ...
  ;(this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r),
    ...
    (this.getHelpXML = function () {
      for (var e = new Array(), a = 0; a < t.length; a++)
        for (var r = t[a].example, n = 0; n < r.length; n++) e[e.length] = r[n]
      for (var p in b) e[e.length] = p
      ...
      for (var a = 0; a < e.length; a++)
        try {
          ...
          var m = document.createTextNode(' ' + e[a] + ' -> ' + i.toRGB() + ' -> ' + i.toHex())
          s.appendChild(h), s.appendChild(m), o.appendChild(s)
        } catch {}
      return o
    })
}
