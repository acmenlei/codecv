import { F as Fe } from './form-data.2b153385.js'
function fe(e, t) {
  return function () {
  ...
  Je = e => {
    ...
    return (
      ...
      ((typeof FormData == 'function' && e instanceof FormData) ||
        de.call(e) === t ||
        (x(e.toString) && e.toString() === t))
    )
  },
  ze = A('URLSearchParams'),
  qe = e => (e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ''))
...
const Ee = typeof self > 'u' ? (typeof global > 'u' ? globalThis : global) : self,
  ye = e => !C(e) && e !== Ee
function V() {
  ...
  for (let r = 0, s = arguments.length; r < s; r++) arguments[r] && F(arguments[r], n)
  return t
}
const $e = (e, t, n, { allOwnKeys: r } = {}) => (
    F(
      t,
      (s, i) => {
        n && x(s) ? (e[i] = fe(s, n)) : (e[i] = s)
      },
      { allOwnKeys: r }
    ),
    e
  ...
  st = () => {},
  ot = (e, t) => ((e = +e), Number.isFinite(e) ? e : t),
  it = e => {
...
function I(e, t, n) {
  ...
  ;(t = t || new (Fe || FormData)()),
    (n = a.toFlatObject(n, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (p, O) {
  ...
  const r = n.metaTokens,
    ...
    i = n.dots,
    o = n.indexes,
    d = (n.Blob || (typeof Blob < 'u' && Blob)) && ut(t)
  ...
  function l(f, p, O) {
    ...
    if (f && !O && typeof f == 'object') {
      if (a.endsWith(p, '{}')) (p = r ? p : p.slice(0, -2)), (f = JSON.stringify(f))
      else if (
        (a.isArray(f) && at(f)) ||
        a.isFileList(f) ||
        (a.endsWith(p, '[]') && (b = a.toArray(f)))
      )
        return (
          (p = Se(p)),
          b.forEach(function (B, _e) {
            !(a.isUndefined(B) || B === null) &&
              t.append(o === !0 ? ne([p], _e, i) : o === null ? p : p + '[]', c(B))
          }),
          !1
        )
    }
    return K(f) ? !0 : (t.append(ne(O, p, i), c(f)), !1)
  }
  const h = [],
    y = Object.assign(ct, { defaultVisitor: l, convertValue: c, isVisitable: K })
  function E(f, p) {
    if (!a.isUndefined(f)) {
      if (h.indexOf(f) !== -1) throw Error('Circular reference detected in ' + p.join('.'))
      h.push(f),
        a.forEach(f, function (b, N) {
          ;(!(a.isUndefined(b) || b === null) &&
            s.call(t, b, a.isString(N) ? N.trim() : N, p, y)) === !0 && E(b, p ? p.concat(N) : [N])
        }),
        h.pop()
    }
  }
...
const Re = Z.prototype
Re.append = function (t, n) {
...
function Ae(e, t, n) {
  ...
  let i
  if (
    (s ? (i = s(t, n)) : (i = a.isURLSearchParams(t) ? t.toString() : new Z(t, n).toString(r)), i)
  ) {
    const o = e.indexOf('#')
...
const se = ft,
  ...
  dt = typeof URLSearchParams < 'u' ? URLSearchParams : Z,
  ht = FormData,
  pt = (() => {
    let e
...
function xe(e) {
  function t(n, r, s, i) {
    ...
    return (
      ...
      d
        ? (a.hasOwnProp(s, o) ? (s[o] = [s[o], r]) : (s[o] = r), !u)
        : ((!s[o] || !a.isObject(s[o])) && (s[o] = []),
          t(n, r, s[o], i) && a.isArray(s[o]) && (s[o] = yt(s[o])),
          !u)
    )
  }
    ...
    function (t, n) {
      ...
      if (i) {
        if (r.indexOf('application/x-www-form-urlencoded') > -1)
          return mt(t, this.formSerializer).toString()
        if ((u = a.isFileList(t)) || r.indexOf('multipart/form-data') > -1) {
          const d = this.env && this.env.FormData
          return I(u ? { 'files[]': t } : t, d && new d(), this.formSerializer)
        }
      }
      return i || s ? (n.setContentType('application/json', !1), bt(t)) : t
    }
  ],
  transformResponse: [
    function (t) {
...
class z {
  ...
  set(t, n, r) {
    ...
    const o = (u, d) => a.forEach(u, (c, l) => i(c, l, d))
    return (
      a.isPlainObject(t) || t instanceof this.constructor
        ? o(t, n)
        : a.isString(t) && (t = t.trim()) && !At(t)
        ? o(St(t), n)
        : t != null && i(n, t, r),
      this
    )
  ...
  delete(t, n) {
    ...
    function i(o) {
      if (((o = P(o)), o)) {
        ...
        u && (!n || ie(r, r[u], u, n)) && (delete r[u], (s = !0))
      }
    }
  ...
  normalize(t) {
    ...
    return (
      a.forEach(this, (s, i) => {
        ...
        const u = t ? Tt(i) : String(i).trim()
        u !== i && delete n[i], (n[u] = U(s)), (r[u] = !0)
      }),
      this
    )
  }
...
`)
  ...
  static accessor(t) {
    const r = (this[oe] = this[oe] = { accessors: {} }).accessors,
      s = this.prototype
    function i(o) {
      const u = P(o)
      r[u] || (xt(s, o), (r[u] = !0))
...
const Pt = S.isStandardBrowserEnv
  ? (function () {
      return {
        write: function (n, r, s, i, o, u) {
          const d = []
          d.push(n + '=' + encodeURIComponent(r)),
            a.isNumber(s) && d.push('expires=' + new Date(s).toGMTString()),
            a.isString(i) && d.push('path=' + i),
            a.isString(o) && d.push('domain=' + o),
            u === !0 && d.push('secure'),
...
function ge(e, t) {
  return e && !Ct(t) ? _t(e, t) : t
}
const Ft = S.isStandardBrowserEnv
  ? (function () {
...
function ae(e, t) {
  ...
  return s => {
    ...
    const l = {
      ...
      bytes: u,
      rate: d || void 0,
      estimated: d && o && c ? (o - i) / d : void 0,
      event: s
    }
    ;(l[t ? 'download' : 'upload'] = !0), e(l)
  }
}
const Lt = typeof XMLHttpRequest < 'u',
  Ut =
    Lt &&
    function (e) {
      return new Promise(function (n, r) {
        ...
        if (e.auth) {
          ...
          i.set('Authorization', 'Basic ' + btoa(E + ':' + f))
        }
        const l = ge(e.baseURL, e.url)
        c.open(e.method.toUpperCase(), Ae(l, e.params, e.paramsSerializer), !0),
          (c.timeout = e.timeout)
        function h() {
          if (!c) return
          const E = R.from('getAllResponseHeaders' in c && c.getAllResponseHeaders()),
            p = {
        ...
        if (
          ...
          (c.ontimeout = function () {
            ...
            const p = e.transitional || Te
            e.timeoutErrorMessage && (f = e.timeoutErrorMessage),
              r(new m(f, p.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, c)),
              (c = null)
          }),
          S.isStandardBrowserEnv)
        ) {
          const E = (e.withCredentials || Ft(l)) && e.xsrfCookieName && Pt.read(e.xsrfCookieName)
          E && i.set(e.xsrfHeaderName, E)
        }
        s === void 0 && i.setContentType(null),
          'setRequestHeader' in c &&
            a.forEach(i.toJSON(), function (f, p) {
...
const jt = {
  getAdapter: e => {
    ...
    if (!r)
      throw r === !1
        ? new m(`Adapter ${n} is not supported by the environment`, 'ERR_NOT_SUPPORT')
        : new Error(
            a.hasOwnProp(j, n)
...
function ce(e) {
  return (
    ...
    (e.data = q.call(e, e.transformRequest)),
    ['post', 'put', 'patch'].indexOf(e.method) !== -1 &&
      e.headers.setContentType('application/x-www-form-urlencoded', !1),
    jt
      .getAdapter(e.adapter || G.adapter)(e)
      .then(
        function (r) {
          return (
            $(e), (r.data = q.call(e, e.transformResponse, r)), (r.headers = R.from(r.headers)), r
          )
        },
        function (r) {
          return (
            Ne(r) ||
              ...
              r &&
                r.response &&
                ((r.response.data = q.call(e, e.transformResponse, r.response)),
...
const ue = e => (e instanceof R ? e.toJSON() : e)
function _(e, t) {
  t = t || {}
  const n = {}
  function r(c, l, h) {
    return a.isPlainObject(c) && a.isPlainObject(l)
      ? a.merge.call({ caseless: h }, c, l)
      : a.isPlainObject(l)
      ? a.merge({}, l)
      : a.isArray(l)
      ? l.slice()
  ...
  const d = {
    ...
    responseEncoding: o,
    validateStatus: u,
    headers: (c, l) => s(ue(c), ue(l), !0)
  }
  return (
    a.forEach(Object.keys(e).concat(Object.keys(t)), function (l) {
      const h = d[l] || s,
        y = h(e[l], t[l], l)
      ;(a.isUndefined(y) && h !== u) || (n[l] = y)
    }),
    n
  )
}
...
const W = { assertOptions: kt, validators: v },
  T = W.validators
class H {
  constructor(t) {
    ;(this.defaults = t), (this.interceptors = { request: new se(), response: new se() })
  }
  request(t, n) {
    ...
    r !== void 0 &&
      ...
      s !== void 0 && W.assertOptions(s, { encode: T.function, serialize: T.function }, !0),
      (n.method = (n.method || this.defaults.method || 'get').toLowerCase())
    let o
    ;(o = i && a.merge(i.common, i[n.method])),
      o &&
    ...
    this.interceptors.request.forEach(function (p) {
      ;(typeof p.runWhen == 'function' && p.runWhen(n) === !1) ||
        ((d = d && p.synchronous), u.unshift(p.fulfilled, p.rejected))
    })
    const c = []
    ...
    if (!d) {
      ...
      for (f.unshift.apply(f, u), f.push.apply(f, c), y = f.length, l = Promise.resolve(n); h < y; )
        l = l.then(f[h++], f[h++])
      return l
    }
    y = u.length
    ...
    for (h = 0, y = c.length; h < y; ) l = l.then(c[h++], c[h++])
    return l
  }
  getUri(t) {
    t = _(this.defaults, t)
...
a.forEach(['delete', 'get', 'head', 'options'], function (t) {
  H.prototype[t] = function (n, r) {
    return this.request(_(r || {}, { method: t, url: n, data: (r || {}).data }))
  }
})
a.forEach(['post', 'put', 'patch'], function (t) {
  function n(r) {
...
class ee {
  constructor(t) {
    ...
    this.promise.then(s => {
      ...
      t(function (i, o, u) {
        r.reason || ((r.reason = new D(i, o, u)), n(r.reason))
      })
  }
  throwIfRequested() {
...
w.isAxiosError = It
w.AxiosHeaders = R
w.formToJSON = e => xe(a.isHTMLForm(e) ? new FormData(e) : e)
w.default = w
const zt = w
export { zt as a }
