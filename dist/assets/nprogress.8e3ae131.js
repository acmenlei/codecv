import { c as w } from './aos.e37f4dc9.js'
var k = { exports: {} }
/* NProgress, (c) 2013, 2014 Rico Sta. Cruz - http://ricostacruz.com/nprogress
 * @license MIT */ ;(function (C, N) {
  ;(function (t, i) {
    C.exports = i()
  })(w, function () {
    var t = {}
    ...
    ;(t.configure = function (r) {
      ...
      (t.set = function (r) {
        var e = t.isStarted()
        ;(r = g(r, i.minimum, 1)), (t.status = r === 1 ? null : r)
        var n = t.render(!e),
          o = n.querySelector(i.barSelector),
          a = i.speed,
          f = i.easing
        return (
          n.offsetWidth,
          T(function (s) {
            i.positionUsing === '' && (i.positionUsing = t.getPositioningCSS()),
              m(o, P(r, a, f)),
              r === 1
                ? (m(n, { transition: 'none', opacity: 1 }),
                  n.offsetWidth,
                  setTimeout(function () {
                    m(n, { transition: 'all ' + a + 'ms linear', opacity: 0 }),
                      setTimeout(function () {
                        t.remove(), s()
                      }, a)
                  }, a))
      ...
      (t.inc = function (r) {
        var e = t.status
        return e
          ? (typeof r != 'number' && (r = (1 - e) * g(Math.random() * e, 0.1, 0.95)),
            (e = g(e + r, 0, 0.994)),
            t.set(e))
          : t.start()
      }),
      ...
      (t.render = function (r) {
        ...
        var n = e.querySelector(i.barSelector),
          o = r ? '-100' : p(t.status || 0),
          a = document.querySelector(i.parent),
          f
        return (
          m(n, { transition: 'all 0 linear', transform: 'translate3d(' + o + '%,0,0)' }),
          i.showSpinner || ((f = e.querySelector(i.spinnerSelector)), f && b(f)),
          a != document.body && h(a, 'nprogress-custom-parent'),
          a.appendChild(e),
          e
        )
      }),
    ...
    function P(r, e, n) {
      ...
      return (
        i.positionUsing === 'translate3d'
          ? (o = { transform: 'translate3d(' + p(r) + '%,0,0)' })
          : i.positionUsing === 'translate'
          ? (o = { transform: 'translate(' + p(r) + '%,0)' })
          : (o = { 'margin-left': p(r) + '%' }),
        (o.transition = 'all ' + e + 'ms ' + n),
        o
      )
    }
    var T = (function () {
      ...
      m = (function () {
        ...
        function o(s) {
          ...
          if (s in u) return s
          for (var c = r.length, d = s.charAt(0).toUpperCase() + s.slice(1), l; c--; )
            if (((l = r[c] + d), l in u)) return l
          return s
        }
        function a(s) {
        ...
        return function (s, u) {
          var c = arguments,
            ...
            l
          if (c.length == 2)
            for (d in u) (l = u[d]), l !== void 0 && u.hasOwnProperty(d) && f(s, d, l)
          else f(s, c[1], c[2])
        }
      })()
    function y(r, e) {
    ...
    function S(r, e) {
      var n = v(r),
        o
      !y(r, e) ||
        ((o = n.replace(' ' + e + ' ', ' ')), (r.className = o.substring(1, o.length - 1)))
    }
    function v(r) {
