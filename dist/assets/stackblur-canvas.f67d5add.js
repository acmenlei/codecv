...
function q2(n, f, T, c, x) {
  if (
    (typeof n == 'string' && (n = document.getElementById(n)),
    !n || X(n) !== 'object' || !('getContext' in n))
  )
    throw new TypeError('Expecting canvas with `getContext` method in processCanvasRGB(A) calls!')
  var s = n.getContext('2d')
  try {
    return s.getImageData(f, T, c, x)
  } catch (e) {
    throw new Error('unable to access image data: ' + e)
  }
}
function H2(n, f, T, c, x, s) {
  if (!(isNaN(s) || s < 1)) {
    s |= 0
    var e = q2(n, f, T, c, x)
    ;(e = z2(e, f, T, c, x, s)), n.getContext('2d').putImageData(e, f, T)
  }
}
function z2(n, f, T, c, x, s) {
  for (
    var e = n.data,
      M2 = 2 * s + 1,
      R = c - 1,
    ...
    (t = t.next = new F2()), d === a && (j = t)
  t.next = w
  for (var o = null, y = null, x2 = 0, r = 0, i = P2[s], B = g2[s], C2 = 0; C2 < x; C2++) {
    t = w
    for (var b = e[r], I = e[r + 1], O = e[r + 2], m = e[r + 3], i2 = 0; i2 < a; i2++)
      (t.r = b), (t.g = I), (t.b = O), (t.a = m), (t = t.next)
    for (
      var F = 0,
        M = 0,
        N = 0,
    ...
    for (var e2 = 0; e2 < c; e2++) {
      ...
      if (((e[r + 3] = t2), t2 !== 0)) {
        ...
        ;(e[r] = ((g * i) >> B) * r2),
          (e[r + 1] = ((q * i) >> B) * r2),
          (e[r + 2] = ((z * i) >> B) * r2)
      } else e[r] = e[r + 1] = e[r + 2] = 0
      ;(g -= p), (q -= S), (z -= u), (H -= _), (p -= o.r), (S -= o.g), (u -= o.b), (_ -= o.a)
      var E = e2 + s + 1
      ;(E = (x2 + (E < R ? E : R)) << 2),
        (F += o.r = e[E]),
        (M += o.g = e[E + 1]),
  ...
  for (var A = 0; A < c; A++) {
    ...
    var h = e[r],
      ...
      W = C * v
    t = w
    for (var G2 = 0; G2 < a; G2++) (t.r = h), (t.g = k), (t.b = D), (t.a = v), (t = t.next)
    for (var R2 = c, v2 = 0, l2 = 0, c2 = 0, s2 = 0, Z = 1; Z <= s; Z++) {
      r = (R2 + A) << 2
      var $ = a - Z
      ;(Q += (t.r = h = e[r]) * $),
        (U += (t.g = k = e[r + 1]) * $),
...
var F2 = function n() {
  N2(this, n), (this.r = 0), (this.g = 0), (this.b = 0), (this.a = 0), (this.next = null)
}
export { H2 as p }
