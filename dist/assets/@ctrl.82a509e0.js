...
function E(r, t, e) {
  return { r: s(r, 255) * 255, g: s(t, 255) * 255, b: s(e, 255) * 255 }
}
function M(r, t, e) {
  ;(r = s(r, 255)), (t = s(t, 255)), (e = s(e, 255))
  ...
  if (a === n) (f = 0), (i = 0)
    ...
    var u = a - n
    switch (((f = h > 0.5 ? u / (2 - a - n) : u / (a + n)), a)) {
      case r:
        i = (t - e) / u + (t < e ? 6 : 0)
        break
      case t:
...
function B(r, t, e) {
  var a, n, i
  if (((r = s(r, 360)), (t = s(t, 100)), (e = s(e, 100)), t === 0)) (n = e), (i = e), (a = e)
  else {
    var f = e < 0.5 ? e * (1 + t) : e + t - e * t,
      h = 2 * e - f
    ;(a = l(h, f, r + 1 / 3)), (n = l(h, f, r)), (i = l(h, f, r - 1 / 3))
  }
...
function N(r, t, e) {
  ;(r = s(r, 360) * 6), (t = s(t, 100)), (e = s(e, 100))
  var a = Math.floor(r),
    n = r - a,
    i = e * (1 - t),
    f = e * (1 - n * t),
...
function W(r) {
  ...
  return (
    ...
    typeof r == 'object' &&
      (g(r.r) && g(r.g) && g(r.b)
        ? ((t = E(r.r, r.g, r.b)), (f = !0), (h = String(r.r).substr(-1) === '%' ? 'prgb' : 'rgb'))
        : g(r.h) && g(r.s) && g(r.v)
        ? ((a = p(r.s)), (n = p(r.v)), (t = N(r.h, a, n)), (f = !0), (h = 'hsv'))
        : g(r.h) &&
          g(r.s) &&
          g(r.l) &&
          ((a = p(r.s)), (i = p(r.l)), (t = B(r.h, a, i)), (f = !0), (h = 'hsl')),
...
function g(r) {
  return Boolean(c.CSS_UNIT.exec(String(r)))
}
var D = (function () {
  function r(t, e) {
  ...
  return (
    ...
    (r.prototype.getLuminance = function () {
      ...
      return (
        ...
        h <= 0.03928 ? (n = h / 12.92) : (n = Math.pow((h + 0.055) / 1.055, 2.4)),
    ...
    (r.prototype.toHex = function (t) {
      return t === void 0 && (t = !1), w(this.r, this.g, this.b, t)
    }),
    ...
    (r.prototype.toPercentageRgb = function () {
      var t = function (e) {
        return ''.concat(Math.round(s(e, 255) * 100), '%')
      }
    ...
    (r.prototype.toName = function () {
      ...
      for (
        var t = '#' + w(this.r, this.g, this.b, !1), e = 0, a = Object.entries(x);
        e < a.length;
        e++
      ) {
        var n = a[e],
    ...
    (r.prototype.monochromatic = function (t) {
      t === void 0 && (t = 6)
      for (var e = this.toHsv(), a = e.h, n = e.s, i = e.v, f = [], h = 1 / t; t--; )
        f.push(new r({ h: a, s: n, v: i })), (i = (i + h) % 1)
      return f
    }),
