import{_ as r,E as y,A as h}from"./index-ece24681.js";import{r as p,b as f,I as k,D as i,o as e,c as l,a as d,V as F,L as C,u as c,n as M,aw as B,F as _,a6 as D,R as g,T as A,O as x}from"./@vue-7f8fdc6b.js";import{k as w}from"./@vueuse-a1dbed23.js";import"./aos-80360ef4.js";import"./element-plus-f3b87d53.js";import"./lodash-es-c7fcb07d.js";import"./async-validator-604317c1.js";import"./@element-plus-4ef95e2d.js";import"./dayjs-d3824421.js";import"./@popperjs-535f1f87.js";import"./@ctrl-aa1b1e70.js";import"./escape-html-7294f491.js";import"./normalize-wheel-es-5e9aec41.js";import"./pinia-211e5b89.js";import"./picture-verification-code-77c40e50.js";import"./axios-93ecc7d0.js";import"./vue-router-7a0d620c.js";import"./nprogress-6c9d9548.js";function T(){const n=p(0),o=w(function(){n.value=(document.documentElement||document.body).scrollTop},50);return f(()=>{document.addEventListener("scroll",o)}),k(()=>{document.removeEventListener("scroll",o)}),n}const H=["level"],N=i({__name:"menuBarItem",props:{MenuItem:null},setup(n){const o=T();return(a,u)=>(e(),l("div",{class:"o_menu-bar_title",level:n.MenuItem.level},[d("span",{class:C({o_active:c(o)>=n.MenuItem.offset&&c(o)<n.MenuItem.offsetMax})},F(n.MenuItem.title),3)],8,H))}});const I=r(N,[["__scopeId","data-v-ccdd5969"]]);function L(n){const o=p([]);return M(()=>{o.value=v(n)}),B(()=>{o.value=v(n)}),o}function v(n){const o=[];return m(o,document.querySelector(n)),S(o),o}function m(n,o,a){const u=o==null?void 0:o.tagName.toLowerCase();if((o==null?void 0:o.nodeType)==1&&u[0]==="h"){const s={offsetMax:0};s.title=o.textContent+"",s.level=+u[1],s.offset=Y(o),s.target=o,n.push(s)}else{if(!o||o.nodeType!=1)return;const s=Array.from(o.children);for(const t of s)m(n,t)}}function Y(n){let o=n==null?void 0:n.offsetTop,a=n.offsetParent;for(;a!==null;)o+=a.offsetTop,a=a.offsetParent;return o}function S(n){for(let o=0,a=n.length;o<a;o++)o+1<a?n[o].offsetMax=n[o+1].offset:n[o].offsetMax=1/0}const $={class:"o_menu_title"},V={key:0,class:"o_menu_bar_container"},z=i({__name:"MenuBar",props:{body:null,menuTitle:null,style:null},emits:["MenuBarClick"],setup(n,{emit:o}){const u=L(n.body);function s(t){h(t.offset),o("MenuBarClick",t)}return(t,R)=>(e(),l("div",{class:"o_navigator_menu",style:A(n.style)},[d("h3",$,F(n.menuTitle||"\u76EE\u5F55"),1),c(u).length?(e(),l("div",V,[(e(!0),l(_,null,D(c(u),(b,E)=>(e(),g(I,{key:E,MenuItem:b,onClick:U=>s(b)},null,8,["MenuItem","onClick"]))),128))])):(e(),g(y,{key:1,title:"\u6682\u65E0\u6807\u9898"}))],4))}});const O=r(z,[["__scopeId","data-v-0f9a0dee"]]);const P=`<h2 style="background:var(--background); color: var(--font-color); margin-bottom: 10px;">
...
<span style="line-height: 28px"
  ...
  ></span
>
</p>`,q={id:"syntax",class:"flex noto-serif-sc","data-aos":"fade-right"},G=i({__name:"syntax",setup(n){const o=p();return f(()=>{o.value.innerHTML=P}),(a,u)=>(e(),l("div",q,[d("div",{class:"syntax-helper",ref_key:"helper",ref:o},null,512),x(O,{class:"slider",body:".syntax-helper",style:{width:"400px"}})]))}});const io=r(G,[["__scopeId","data-v-33824818"]]);export{io as default};
