import{s as y}from"./index-236cb0d8.js";import{k as h}from"./@vueuse-b9e3df3e.js";import{r,b as f,J as k,E as p,o as e,c as l,a as i,W as F,M as C,u as c,n as M,aw as B,F as _,a7 as D,S as g,U as A,P as x}from"./@vue-4e9b796a.js";import{_ as d,E as w}from"./index-1580765e.js";import"./config-5cd0b23e.js";import"./element-plus-05a242d7.js";import"./lodash-es-9d35530d.js";import"./async-validator-604317c1.js";import"./@element-plus-8517150f.js";import"./dayjs-d3824421.js";import"./aos-80360ef4.js";import"./@popperjs-535f1f87.js";import"./@ctrl-aa1b1e70.js";import"./markdown-transform-html-1da660b5.js";import"./pinia-1e29946c.js";import"./picture-verification-code-77c40e50.js";import"./vue-router-329aefc2.js";import"./nprogress-6c9d9548.js";function T(){const n=r(0),o=h(function(){n.value=(document.documentElement||document.body).scrollTop},50);return f(()=>{document.addEventListener("scroll",o)}),k(()=>{document.removeEventListener("scroll",o)}),n}const H=["level"],N=p({__name:"menuBarItem",props:{MenuItem:null},setup(n){const o=T();return(a,u)=>(e(),l("div",{class:"o_menu-bar_title",level:n.MenuItem.level},[i("span",{class:C({o_active:c(o)>=n.MenuItem.offset&&c(o)<n.MenuItem.offsetMax})},F(n.MenuItem.title),3)],8,H))}});const I=d(N,[["__scopeId","data-v-ccdd5969"]]);function L(n){const o=r([]);return M(()=>{o.value=v(n)}),B(()=>{o.value=v(n)}),o}function v(n){const o=[];return E(o,document.querySelector(n)),S(o),o}function E(n,o,a){const u=o==null?void 0:o.tagName.toLowerCase();if((o==null?void 0:o.nodeType)==1&&u[0]==="h"){const s={offsetMax:0};s.title=o.textContent+"",s.level=+u[1],s.offset=Y(o),s.target=o,n.push(s)}else{if(!o||o.nodeType!=1)return;const s=Array.from(o.children);for(const t of s)E(n,t)}}function Y(n){let o=n==null?void 0:n.offsetTop,a=n.offsetParent;for(;a!==null;)o+=a.offsetTop,a=a.offsetParent;return o}function S(n){for(let o=0,a=n.length;o<a;o++)o+1<a?n[o].offsetMax=n[o+1].offset:n[o].offsetMax=1/0}const $={class:"o_menu_title"},P={key:0,class:"o_menu_bar_container"},z=p({__name:"MenuBar",props:{body:null,menuTitle:null,style:null},emits:["MenuBarClick"],setup(n,{emit:o}){const u=L(n.body);function s(t){y(t.offset),o("MenuBarClick",t)}return(t,J)=>(e(),l("div",{class:"o_navigator_menu",style:A(n.style)},[i("h3",$,F(n.menuTitle||"\u76EE\u5F55"),1),c(u).length?(e(),l("div",P,[(e(!0),l(_,null,D(c(u),(b,m)=>(e(),g(I,{key:m,MenuItem:b,onClick:O=>s(b)},null,8,["MenuItem","onClick"]))),128))])):(e(),g(w,{key:1,title:"\u6682\u65E0\u6807\u9898"}))],4))}});const U=d(z,[["__scopeId","data-v-1da65201"]]);const V=`<h2 style="background:var(--background); color: var(--font-color)">
...
<span style="line-height: 28px"
  ...
  ></span
>
</p>`,q={id:"syntax",class:"flex","data-aos":"fade-right"},G=p({__name:"syntax",setup(n){const o=r();return f(()=>{o.value.innerHTML=V}),(a,u)=>(e(),l("div",q,[i("div",{class:"syntax-helper",ref_key:"helper",ref:o},null,512),x(U,{class:"slider",body:".syntax-helper",style:{width:"300px"}})]))}});const io=d(G,[["__scopeId","data-v-834c2277"]]);export{io as default};
