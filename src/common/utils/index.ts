...
// 设置光标位置
export function setCurrentCursorPosition(position: {
  ...
  range.setStart(<Node>position.startContainer, position.startOffset)
  range.setEnd(<Node>position.endContainer, position.endOffset)
